...
# (str) Package name
package.name = voctrainer

# (str) Package domain (needed for android/ios packaging)
package.domain = org.voctrainer
...
source.exclude_exts = spec,txt,pyc,ini

# (list) List of directory to exclude (let empty to not exclude anything)
source.exclude_dirs = backups, bin, __pycache__
...
#android.sdk_path = /home/lorenz/Documents/Programmieren/android-sdk
